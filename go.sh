...
#echo '1A:Run GOA/Mouse/Noctua Load' | tee -a ${GOLOG}
#${GOLOAD}/goamousenoctua/goamousenoctua.sh | tee -a ${GOLOG}

echo '1:Run GOA/Mouse Load' | tee -a ${GOLOG}
${GOLOAD}/goamouse/goamouse.sh | tee -a ${GOLOG}

echo '2:Run GOA/Rat Load' | tee -a ${GOLOG}
${GOLOAD}/goarat/goarat.sh | tee -a ${GOLOG}

echo '3:Run GOA/PAINT Load' | tee -a ${GOLOG}
${GOLOAD}/goarefgen/goarefgen.sh | tee -a ${GOLOG}

echo '4:Run GOA/Human Load' | tee -a ${GOLOG}
${GOLOAD}/goahuman/goahuman.sh | tee -a ${GOLOG}

echo '5:Run GOA/CFP Load' | tee -a ${GOLOG}
